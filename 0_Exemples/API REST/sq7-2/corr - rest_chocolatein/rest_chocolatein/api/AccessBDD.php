...
//\"$datemesure\"
	/**
	 * récupération des lignes correspondants à un ceraint champ
	 * @param string $table nom de la table
	 * @param int $champ champs des lignes à récupérer
	 * @return lignes de la table dont le champ correspond à la valeur
	 */	
	public function selecAllWanted($table, $champ, $expected_value){
		print("yooy");
		if($this->conn != null){
			return $this->conn->query("select * from $table where champ=\"$expected_value\";");		
		}else{
			return null;
		}
	}
